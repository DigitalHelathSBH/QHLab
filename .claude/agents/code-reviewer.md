<!--
TEMPLATE — generally usable as-is, no project-specific placeholders.
Copy into a project's .claude/agents/ folder unchanged unless the project
has unusual review conventions worth adding.
-->
---
name: code-reviewer
